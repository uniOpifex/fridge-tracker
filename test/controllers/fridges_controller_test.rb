...
class FridgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fridge" do
    assert_difference('Fridge.count') do
      post fridges_url, params: { fridge: { brand: @fridge.brand, location: @fridge.location, size: @fridge.size } }
    end
  ...
  test "should update fridge" do
    patch fridge_url(@fridge), params: { fridge: { brand: @fridge.brand, location: @fridge.location, size: @fridge.size } }
